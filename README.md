...
If you use federation-resilience in your work, please cite it via its DOI: [10.5281/zenodo.20694953](https://doi.org/10.5281/zenodo.20694953). Machine-readable metadata lives in [`CITATION.cff`](CITATION.cff). Built from a confirmed inspection of `@module-federation/enhanced@2.5.1` — see [`docs/scenario_provenance.md`](docs/scenario_provenance.md) and [`docs/adapter_guide.md`](docs/adapter_guide.md).
