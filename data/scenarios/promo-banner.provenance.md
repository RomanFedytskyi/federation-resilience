# Provenance — promo-banner-flapping-no-fallback

> **Template — fill these in before publishing numbers from this scenario.**

- **Remote:** `promo/Banner`
- **Entry URL:** https://cdn.shop.example/promo/remoteEntry.js
- **Fallback:** none (optional UI)
...
The `attempts[].latencyMs` and `fallback.latencyMs` in `promo-banner.json` are
