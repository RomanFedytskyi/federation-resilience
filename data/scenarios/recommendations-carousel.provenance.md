# Provenance — recommendations-carousel-healthy-baseline

> **Template — fill these in before publishing numbers from this scenario.**

- **Remote:** `recommendations/Carousel`
- **Entry URL:** https://cdn.shop.example/recommendations/remoteEntry.js
- **Fallback:** `recommendations-stable/Carousel`
...
The `attempts[].latencyMs` and `fallback.latencyMs` in `recommendations-carousel.json` are
